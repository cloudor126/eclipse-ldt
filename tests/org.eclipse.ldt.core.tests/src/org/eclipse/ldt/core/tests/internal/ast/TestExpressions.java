...
import org.eclipse.ldt.core.internal.ast.parser.LuaSourceParser;
import org.eclipse.ldt.core.internal.ast.parser.LuaSourceParserFactory;
import org.eclipse.ldt.core.tests.internal.ast.utils.DummyReporter;
...
public class TestExpressions extends TestCase {
	...
	public void testTable() {
		...
		module = parse("table = {1,'2',}"); //$NON-NLS-1$
		assertFalse("Table with trailing comma is not recognized.", module.isEmpty()); //$NON-NLS-1$
		module = parse("table = {1,'2';}"); //$NON-NLS-1$
