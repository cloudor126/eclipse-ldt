...
public class Lua52InterpreterInstall extends AbstractLuaInterpreterInstall {

	public Lua52InterpreterInstall(final IInterpreterInstallType type, final String id) {
		super(type, id);
	}
}
